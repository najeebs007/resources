...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append(
			...
			<li data-criterion="LowerCase" class="valid">At least <strong>one lowercase letter</strong></li> \
			 <li data-criterion="number" class="valid">At least <strong>one number</strong></li> \
			<li data-criterion="specChar" class="valid">At least <strong>one Special character (!,$,@ etc.)</strong></li>\
    ...
    Plugin.prototype._bind_input_events = function($s) {
        ...
        $s.bind('keyup', function () {
			...
			var specialcharacters = password.match(specialChar) ? 1 : 0;
            var containWhiteSpace = password.indexOf(' ') >= 0 ? 1 : 0;

            var total = characters + capitalletters + loweletters + number+specialcharacters;
            ...
            that._update_info('number', number);
			 that._update_info('LowerCase', loweletters);
			 that._update_info('specChar', specialcharacters);
