	...
	function ratingStarCount() {
		...
		ajaxWithJSON("/load-star-count", null, 'GET', function(response) {debugger;
					...
					var percentOneStar = (Math.floor((l_oneStar / totalStar) * 100))+ "%";
						...
						r_html += '<span class="rating-text-normal">'+targetUser+'</span></br> ';
						r_html += '<span class="rating-text" style="color: black; font-weight: 500;">'+averageRating+' out of 5</span>';
						r_html += '	</div>';
						...
						r_html += '</span><span class="rating-text" style="color: black; font-weight: 500;">'+starRatingSum+'</span>';
						r_html += '</div>';
						r_html += '</div>';
						r_html += '</div>';
						r_html += '</div>';
						...
						r_html += '</div>';
						r_html += '</div>';
						r_html += '<div class="side right"><div>'+percentFiveStar+'</div></div>';
						r_html += '<div class="side"><div>4 star</div></div>';
						r_html += '<div class="middle"> <div class="bar-container"> <div class="bar" style="width: '+percentFourStar+';"></div></div></div>';
						r_html += '<div class="side right"> <div>'+percentFourStar+'</div> </div>';
						r_html += '<div class="side"> <div>3 star</div> </div> ';
						r_html += '<div class="middle"> <div class="bar-container"> <div class="bar" style="width: '+percentThreeStar+';"></div> </div> </div>';
						r_html += '<div class="side right"> <div>'+percentThreeStar+'</div> </div>';
						r_html += '<div class="side"><div>2 star</div></div>';
						r_html += '<div class="middle"> <div class="bar-container"> <div class="bar" style="width: '+percentTwoStar+';"></div> </div></div>';
						r_html += ' <div class="side right"> <div>'+percentTwoStar+'</div> </div>';
						r_html += '<div class="side"> <div>1 star</div> </div>';
						r_html += '<div class="middle"> <div class="bar-container">';
						r_html += '<div class="bar" style="width: '+percentOneStar+';"></div> </div>';
						r_html += '</div>';
